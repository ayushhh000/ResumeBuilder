...
export const ProfileInfoCard = () => {
  ...
  return (
    user && (
      <div className={cardStyles.profileCards}>
    ...
    <div
      ...
      ${
        isSelected
          ...
          : " border-grey-200 hover:border-violet-300"
      }`}
      onClick={onSelect}
    >
      {thumbnailImg ? (
        <div className=" relative w-full h-full overflow-hidden">
          ...
          <div
            className=" absolute inset-0 bg-gradient-to-t from-white/60 via-transparent 
        ...
        <div
          className=" w-full h-[200px] flex items-center flex-col justify-center bg-gradient-to-br 
        ...
        >
          ...
          <span className=" text-grey-700 font-bold">No Preview</span>
        </div>
      )}
    </div>
  );
