  ...
  return (
    <div className=" max-w-7xl mx-auto px-4">
      ...
      <div className=" grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8">
        <div className=" lg:col-span-2 bg-white rounded-2xl border border-grey-100 p-4 sm:p-6">
          <div
        ...
        {/* Right area */}
        <div
          className=" lg-col-span-3 bg-white rounded-2xl border border-grey-100 p-4 sm:p-6"
          ref={resumeRef}
        >
          <RenderResume
